...
static const char *fonts[]          = {
    "hacknerdfontmono:pixelsize=30",
    "WenQuanYi Micro Hei:size=10",
};
static const char dmenufont[]       = "WenQuanYi Micro Hei:size=30";
...
static const char *pcmanfmcmd[]  = { "firefox", NULL };

static const char *mapsetcmd[]  = { "sh", "-c", "setxkbmap us colemak; xmodmap /home/chris/.Xmodmap", NULL };
// User Defined End
